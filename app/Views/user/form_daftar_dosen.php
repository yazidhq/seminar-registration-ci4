                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="card rounded-3">
                        ...
                        <div class="card-body p-md-5">
                            ...
                            <form action="/Peserta/tambah_dosen/<?= $seminar['id_seminar'] ?>" method="post" class="px-md-2" id="search" onsubmit="return validateForm(event)">
...
<script>
    function validateForm(event) {
        ...
        if (nip.value.trim() !== '' && nama.value.trim() !== '' && email.value.trim() !== '' && wa.value.trim() !== '' && instansi.value.trim() !== '') {
            Swal.fire({
