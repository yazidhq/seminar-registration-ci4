                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="card rounded-3">
                        ...
                        <div class="card-body p-md-5">
                            ...
                            <form action="/Peserta/tambah_mahasiswa/<?= $seminar['id_seminar'] ?>" method="post" class="px-md-2" id="search" onsubmit="return validateForm(event)">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="npm" name="npm" required>
                                </div>
                                <div class="mb-3">
...
<script>
    function validateForm(event) {
        ...
        if (npm.value.trim() !== '' && nama.value.trim() !== '' && email.value.trim() !== '' && wa.value.trim() !== '' && instansi.value.trim() !== '' && jurusan.value.trim() !== '') {
            Swal.fire({
